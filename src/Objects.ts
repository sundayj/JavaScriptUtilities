 ...
 */
export const get = (from: any, ...selectors: any[]): any[] =>
    [...selectors].map(s =>
        s
            .replace(/\[([^\[\]]*)\]/g, '.$1.')
            .split('.')
 ...
 */
export const deepMerge = (a: any, b: any, fn: any) =>
...
export const CSVToJSON = (data: string, delimiter = ',') => {
    ...
    return data
        ...
        .map(v => {
            ...
            return titles.reduce((obj: {[x: string]: any;}, title: string, index: number) => ((obj[title] = values[index]), obj), {});
        });
};
 ...
 */
export const compactObject = (val: {[x: string]: any;} | any[]) => {
 ...
 * // {5: 2, 10: 1}
 */
export const countBy = (arr: any[], fn: ((x: any) => any) | string | number | 'function') =>
 ...
 * // {3: ['one', 'two'], 5: ['three']}
 */
export const groupBy = (arr: any[], fn: ((x: any) => any) | string | number | 'function') =>
    arr
...
export const queryStringToObject = (url: string) =>
     [...(new URLSearchParams(url.split('?')[1])).entries()].reduce(
        (a: {[x: string]: any;}, [k, v]) => ((a[k] = v), a),
        {}
    );
 ...
 * // '{"n":42}'
 */
export const stringifyCircularJSON = (obj: any) => {
...
export const toPairs = (obj: any) => {
    // @ts-ignore
    return obj[Symbol.iterator] instanceof Function && obj.entries instanceof Function
 ...
 * // { '1': ['a', 'c'], '2': ['b'] }
 */
export const transform = (obj: { [x: string]: any; }, fn: (arg0: any, arg1: any, arg2: string, arg3: any) => any, acc: any) =>
 ...
 *
 */
export const unflattenObject = (obj: { [x: string]: any; }) =>
    Object.keys(obj).reduce((res, k) => {
        k.split('.').reduce(
            (acc: { [x: string]: any; }, e: string, i: number, keys: string[]) =>
                acc[e] ||
 ...
 *
 */
export const walkThrough = function* (obj: any) {
    const walk: (x: { [p: string]: any }, previous?: any[]) => Generator<any | [any[], any], void, any> = function* (x: { [x: string]: any; }, previous: any[] = []) {
